            ...
            <div className="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    Efficiently manage tasks with our drag-and-drop
                    functionality. Organize tasks into to-do, ongoing, and
                    completed lists for a clear overview.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 border rounded-xl border-r-gray-200 dark:border-gray-700">
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-500 dark:text-gray-300">
                    Maintain a clutter-free dashboard by easily deleting tasks
                    you no longer need. Your control over your tasks is just a
                    click away.
                  </p>
                </div>
              </div>
