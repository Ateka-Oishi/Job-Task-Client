              ...
              <div className="w-full space-y-12 lg:w-1/2 ">
                ...
                >
                  ...
                  <div className="mt-4 md:mx-4 md:mt-0">
                    ...
                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                      Welcome to our collaborative task management platform
                      designed to streamline your workflow and enhance
                      productivity. Say goodbye to scattered to-do lists and
                      welcome a smarter way to manage tasks.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="mt-4 md:mx-4 md:mt-0">
                    ...
                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                      Our platform caters to a diverse range of professionals,
                      including developers, corporate professionals, bankers,
                      and anyone seeking efficient task management. No matter
                      your industry, our platform is tailored to meet your
                      needs.
                    </p>
                  </div>
                </div>
