  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="container px-5 py-10 mx-auto">
        <h3 className="text-center text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">
          Latest News
        </h3>

        <div className="grid grid-cols-1 gap-8 mt-8 md:mt-16 md:grid-cols-2 [&>div]:shadow-lg [&>div]:rounded-lg">
