      ...
      <section>
        <div className="container mx-auto px-5 py-10">
          <div className="flex justify-center gap-3">
            <div className="drawer w-20 absolute z-40 md:hidden">
              <input id="my-drawer" type="checkbox" className="drawer-toggle" />
              <div className="drawer-content">
                {/* Page content here */}
                <label
                  htmlFor="my-drawer"
                  className="fixed left-2 top-[20%] btn !btn-sm btn-primary drawer-button flex items-center"
                >
                  <svg
              ...
              <div className="drawer-side">
                ...
                ></label>
                <div>
                  <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-gray-200 border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                    <div className="flex flex-col items-center mt-6 -mx-2">
                      <img
                        ...
                        alt="avatar"
                      />
                      <span className="mx-2 mt-2 font-medium text-gray-800 dark:text-gray-200">
                        {user?.displayName}
                      </span>
                      <span className="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400">
                        {user?.email}
                      </span>
                    </div>
